...
public class Lesson1PlotPanel extends JFrame implements Printable, EnergyUsageProvider, CumulativeTimeProvider
{
	Lesson1PlotPanel myself;
    ...
    public Lesson1PlotPanel(String title, BranchData branch,
    		...
    		double ymin, double ymax)
    {
		...
		currentCalendar.add(Calendar.MINUTE, -2); // stop at 23:59

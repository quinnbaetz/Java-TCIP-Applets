 ...
 * 
 * @author Zeb Tate - TimeRangeModel
 */
public class TimeRangeModel implements BoundedRangeModel, Serializable
{
	
	TimeRangeModelExtentEditor extentEditor = null;
	
	public BoundedRangeModel getExtentEditor() {
		if (extentEditor == null)
			extentEditor = new TimeRangeModelExtentEditor(this);
		
		return extentEditor;
	}
	
	public class TimeRangeModelExtentEditor extends TimeRangeModel {
		TimeRangeModel mymodel;
		
		public TimeRangeModelExtentEditor(TimeRangeModel tmodel) {
			super();
			mymodel = tmodel;
		}

		public TimeRangeModelExtentEditor(int value, int extent, int min,
				int max) {
     ...
     * </pre>
     */
    public TimeRangeModel(int value, int extent, int min, int max)
    {
        if ((max >= min) &&
            (value >= min) &&
            ((value + extent) >= value) &&

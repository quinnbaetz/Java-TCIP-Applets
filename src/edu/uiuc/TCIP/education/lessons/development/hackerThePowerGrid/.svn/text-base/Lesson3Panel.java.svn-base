...
public class Lesson3Panel extends JPanel implements ItemListener, ActionListener {
	...
	private void initializeDisplay() {
		...
		Insets noMargin = new Insets(2,2,2,2);
		
		branchOverloadMonitorCheckbox = new JCheckBox("Monitor branch overloads");
		branchOverloadMonitorCheckbox.setMargin(noMargin);
		...
		*/
		...
		ShowPlotWindow.setMargin(noMargin);
		...
		AttackButton.setFont(new Font("Lucida Bright", Font.BOLD, 12));
		AttackButton.setMargin(noMargin);
	...
	private void setupPowerSystem() {
		...
		circuitpanel.getAnimatables().add(fA); addSwitchToAttackableSwitchesFromArrayList(lines);

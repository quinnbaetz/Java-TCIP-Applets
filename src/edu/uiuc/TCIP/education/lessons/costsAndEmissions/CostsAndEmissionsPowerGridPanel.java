...
public class CostsAndEmissionsPowerGridPanel extends JPanel implements ItemListener {
	...
	CostsAndEmissionsPowerGridPanel myself;
	...
	double initialWindVariation = 1;
	double initialWindGen = 50;
	...
	public CostsAndEmissionsPowerGridPanel() {
		initializeDisplay();
	}
	...
	private void setupPowerSystem() {
		...
		BranchData branchFiveToFifteen = new BranchData(nodeFive,nodeFifteen,0.01,0,1500.0,false);
		...
		BranchData branchSixToSixteen = new BranchData(nodeSix,nodeSixteen,0.01,0,1500.0,false); // to wind generator
		...
		GeneratorDataWithLinearCostAndEmissions genHydro = new GeneratorDataWithLinearCostAndEmissions(nodeEight,1000,500,1000,0,0,9999,true,1500,3.0,0,0,includeFixedCostsAndEmissions);
		...
		GeneratorDataWithLinearCostAndEmissions genCoal = new GeneratorDataWithLinearCostAndEmissions(nodeNine,600,300,700,0,0,9999,true,2000,20.0,0,1.0,includeFixedCostsAndEmissions);
		...
		GeneratorDataWithLinearCostAndEmissions genNuke = new GeneratorDataWithLinearCostAndEmissions(nodeTen,900,900,900,0,0,9999,true,6500.0,6.0,0,0,includeFixedCostsAndEmissions);

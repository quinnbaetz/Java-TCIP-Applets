...
public class StackedTimeSeriesPlot extends JFrame implements Printable, Animatable
{
	StackedTimeSeriesPlot myself;
    ...
    XYPlot timePlot;
    DateAxis xaxis;
    TimeSeries plotTimeSeriesBottom, plotTimeSeriesTop;
    
    public StackedTimeSeriesPlot(String title, 
    		double ymin, double ymax,
    		int xsize, int ysize, 
    		TimeSeries plotTimeSeriesBottom,
    		TimeSeries plotTimeSeriesTop,
    		String yaxisLabel)
    {
    	super(title);
        myself = this;
        ...
        this.plotTimeSeriesBottom = plotTimeSeriesBottom;
        this.plotTimeSeriesTop = plotTimeSeriesTop;
		totalDataSet.addSeries(plotTimeSeriesBottom);
		totalDataSet.addSeries(plotTimeSeriesTop);
		...
		TimeSeriesTableXYDataSet tset = new TimeSeriesTableXYDataSet();
		tset.setTimeSeriesCollection(totalDataSet);
        timePlot = new XYPlot(tset,xaxis,yaxis,new StackedXYAreaRenderer2());
